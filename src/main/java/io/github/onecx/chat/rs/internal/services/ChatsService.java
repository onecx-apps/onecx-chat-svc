package io.github.onecx.chat.rs.internal.services;
...
public class ChatsService {
    ...
    public Response createChatMessage(String chatId, CreateMessageDTO createMessageDTO) {
        ...
        if (chat == null) {
            throw new ConstraintException("Chat does not exist", ChatsService.ChatErrorKeys.CHAT_DOES_NOT_EXIST, null);
        }
